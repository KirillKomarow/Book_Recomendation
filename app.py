...
title = st.text_input(label='Please enter book name')
title = title.lower()
...
option = st.selectbox(label='Select the book you need', options=output['title'].values)
...
if option:
    ...
    count_recomendation = st.number_input(label='Specify the number of recommendations you need',value=10)
